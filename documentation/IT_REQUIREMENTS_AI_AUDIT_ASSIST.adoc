...
Für kleinere Datenmengen und geringe bis moderate Nutzerzahlen: * Dokumentensammlung bis
ca. 100 MB *Geringe bis moderate gleichzeitige Nutzer
...
Für wachsende Datenmengen und höhere Nutzerzahlen: * Dokumentensammlung bis ca. 5 GB *
...
Dokumentensammlung über 5 GB * Viele gleichzeitige Nutzer bzw. komplexe, rechenintensive
Abfragen
