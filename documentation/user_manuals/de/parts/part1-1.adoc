...
image::../images/Abbildung-5.jpg[Navigationsbereich KI Chat  - löschen, title="Navigationsbereich KI Chat  - löschen", width=200]
...
|image:../images/Abbildung-36.jpg[Aus RAG-System entfernen (Dokument bleibt in der Ordnerstruktur gespeichert)] | Aus RAG-System entfernen (Dokument bleibt in der Ordnerstruktur gespeichert)
